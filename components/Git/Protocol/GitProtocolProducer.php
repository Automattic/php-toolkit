...
class GitProtocolProducer implements ByteProducer {
    ...
    private function append_packfile_data(): bool {
        ...
        if(!$this->packfile_writer) {
            $this->packfile_writer = new WriteStream($this->output_bytes, [
        ...
        if (!$this->object_reader) {
            ...
            $this->packfile_object_body_writer = new WriteStream($this->packfile_writer, [
