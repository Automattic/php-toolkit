...
class ZipDecoder {
	...
	private $state = ZipDecoder::STATE_SCAN;
	private $object = null;
	private $byte_reader;
    ...
    private function read_file_entry() {
        ...
        $this->object->path = ZipDecoder::sanitize_path($path);
        ...
        $is_compressed = $this->object->compressionMethod === ZipDecoder::COMPRESSION_DEFLATE;
        if($is_compressed) {
