...
if ( ! function_exists( __NAMESPACE__ . '\\wp_is_valid_utf8' ) ) {
...
if ( ! function_exists( __NAMESPACE__ . '\\wp_scrub_utf8' ) ) {
	if (
...
if ( ! function_exists( __NAMESPACE__ . '\\_wp_can_use_pcre_u' ) ) {
...
if ( ! function_exists( __NAMESPACE__ . '\\wp_has_noncharacters' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\utf8_ord' ) ) {
