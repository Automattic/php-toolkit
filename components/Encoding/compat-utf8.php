 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_scan_utf8' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_is_valid_utf8_fallback' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_scrub_utf8_fallback' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_utf8_codepoint_count' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_utf8_codepoint_span' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_has_noncharacters_fallback' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_utf8_encode_fallback' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\_wp_utf8_decode_fallback' ) ) {
