...
class DatabaseContentEntityReaderTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        // Set up reader
        $this->reader = DatabaseContentEntityReader::create($this->db, [
            'table_prefix' => 'wp_'
        ]);
    }
    ...
    public function testExportOrder(): void {
        $expectedOrder = [
            'Parent Post 1', 'Child Post 11',
            'Parent Post 2', 'Child Post 12',
            'Parent Post 3', 'Child Post 13',
            'Parent Post 4', 'Child Post 14',
            'Parent Post 5', 'Child Post 15',
            'Parent Post 6', 'Child Post 16',
            'Parent Post 7', 'Child Post 17',
            'Parent Post 8', 'Child Post 18',
            'Parent Post 9', 'Child Post 19',
            'Parent Post 10', 'Child Post 20'
        ];
