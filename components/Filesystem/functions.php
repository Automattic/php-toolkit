...
if ( ! function_exists( __NAMESPACE__ . '\\ls_recursive' ) ) {
 ...
 * }
 */
if ( ! function_exists( __NAMESPACE__ . '\\copy_between_filesystems' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\pipe_stream' ) ) {
...
if ( ! function_exists( __NAMESPACE__ . '\\wp_unix_path_segments' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\wp_unix_path_resolve_dots' ) ) {
 ...
 * as separators.
 */
if ( ! function_exists( __NAMESPACE__ . '\\wp_unix_sys_get_temp_dir' ) ) {
 ...
 */
if ( ! function_exists( __NAMESPACE__ . '\\wp_unix_dirname' ) ) {
