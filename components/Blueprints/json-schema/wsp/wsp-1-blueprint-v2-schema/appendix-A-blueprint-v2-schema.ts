...
export type Blueprint = {
  ...
  blueprintMeta?: {
    ...
    authorUrl?: URLReference; // Example: "https://example.com"
   ...
   * ```
   */
  muPlugins?: URLReference | ExecutionContextPath[];
...
type PluginStringReference =
  | PluginDirectoryReference
  | URLReference
  | ExecutionContextPath;

type PluginDefinition =
  | PluginStringReference
  | {
  source: PluginStringReference;
...
type Step =
   ...
   */
  zipFile: URLReference | ExecutionContextPath;
  /**
