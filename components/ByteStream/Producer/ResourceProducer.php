...
class ResourceProducer extends BaseByteProducer {
    ...
    static public function from_local_file($file_path) {
        ...
        return self::from_resource_handle($handle, filesize($file_path));
    }

    static public function from_resource_handle($handle, $expected_length = null) {
